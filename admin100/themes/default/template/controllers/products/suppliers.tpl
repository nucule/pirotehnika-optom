					...
					<table class="table">
						...
						{foreach $attributes AS $index => $attribute}
							...
							<tr {if $index is odd}class="alt_row"{/if}>
								...
								<td>
									<input type="text" value="{$product->reference|escape:'html':'UTF-8'}" name="supplier_reference_{$attribute['id_product']}_{$attribute['id_product_attribute']}_{$supplier->id_supplier}" />
								</td>
								<td>
									<input type="text" value="{$product->price|htmlentities}" name="product_price_{$attribute['id_product']}_{$attribute['id_product_attribute']}_{$supplier->id_supplier}" />
								</td>
								<td>

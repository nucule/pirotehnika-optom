...
<div id="product-informations" class="panel product-tab">
		...
		<div class="col-lg-9">
			<div class="radio">
				<label for="simple_product">
					<input type="radio" name="type_product" id="simple_product" value="{Product::PTYPE_SIMPLE}" {if $product_type == Product::PTYPE_SIMPLE}checked="checked"{/if} {if $my_employee_filter == true}disabled{/if} >
					{l s='Standard product'}</label>
			</div>
			<div class="radio">
				<label for="pack_product">
					<input type="radio" name="type_product" {if $is_in_pack}disabled="disabled"{/if} id="pack_product" value="{Product::PTYPE_PACK}" {if $product_type == Product::PTYPE_PACK}checked="checked"{/if} {if $my_employee_filter == true}disabled{/if} > {l s='Pack of existing products'}</label>
			</div>
			<div class="radio">
				<label for="virtual_product">
					<input type="radio" name="type_product" id="virtual_product" {if $is_in_pack}disabled="disabled"{/if} value="{Product::PTYPE_VIRTUAL}" {if $product_type == Product::PTYPE_VIRTUAL}checked="checked"{/if} {if $my_employee_filter == true}disabled{/if} >
	...
	<div class="form-group">
		...
		<div class="col-lg-5">
			<input type="text" id="reference" name="reference" value="{$product->reference|htmlentitiesUTF8}" {if $my_employee_filter == true}readonly{/if} />
		</div>
	</div>
<!-- Иванов -->
...
<!-- 	
	<div class="form-group">
		<label class="control-label col-lg-3" for="ean13">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s='This type of product code is specific to Europe and Japan, but is widely used internationally. It is a superset of the UPC code: all products marked with an EAN will be accepted in North America.'}">
				{$bullet_common_field} Штрих код упаковки товара
			</span>
		</label>
		<div class="col-lg-3">
			<input maxlength="13" type="text" id="ean13_2" name="ean13_2" value="{$product->ean13_2|htmlentitiesUTF8}" />
		</div>
	</div>
<!-- Штрих код штуки -->
...
<!-- 	<div class="form-group">
		<label class="control-label col-lg-3" for="ean13">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s='This type of product code is specific to Europe and Japan, but is widely used internationally. It is a superset of the UPC code: all products marked with an EAN will be accepted in North America.'}">
				{$bullet_common_field} Штрих код единицы товара
			</span>
		</label>
		<div class="col-lg-3">
			<input maxlength="13" type="text" id="ean13_3" name="ean13_3" value="{$product->ean13_3|htmlentitiesUTF8}" />
		</div>
	</div>
 -->	
 -->
...
<!-- 	<div class="form-group">
 ...
 -->
<!-- Иванов ^ -->
<!-- Иванов Страна происхождения -->
	<div class="form-group">
		<label class="control-label col-lg-3">
			{$bullet_common_field} Страна происхождения
		</label>
		<div class="col-lg-9">
			<div class="radio">
				<label id="label_my_country_1" for="my_country_1">
					<input type="radio" name="country_prois" id="country_prois_1" value="1" class="country_prois" {if $product->country_prois == 1} checked="checked" {/if}  >
					Китай</label>
			</div>
			<div class="radio">
				<label id="label_my_country_2" for="my_country_2">
					<input type="radio" name="country_prois" id="country_prois_2" value="2" class="country_prois" {if $product->country_prois == 2} checked="checked" {/if}  > 
					Россия</label>
			</div>
			<div class="radio">
				<label id="label_my_country_3" for="my_country_3">
					<input type="radio" name="country_prois" id="country_prois_3" value="3" class="country_prois" {if $product->country_prois == 3} checked="checked" {/if} >
					Польша</label>
			</div>
		</div>
	</div>
<!-- Иванов ^ -->
	<div class="form-group">
		<label class="control-label col-lg-3" for="sert">
			<span class="label-tooltip" data-toggle="tooltip"
				title="Краткий номер сертификата соответсвия">
				{$bullet_common_field} Сертификат соответствия
			</span>
		</label>
		<div class="col-lg-3">
			<input type="text" id="sert" name="sert" value="{$product->sert|htmlentitiesUTF8}" />
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-lg-3" for="sert_full">
			<span class="label-tooltip" data-toggle="tooltip"
				title="Полный номер сертификата соответсвия">
				{$bullet_common_field} Сертификат соответствия (полный)
			</span>
		</label>
		<div class="col-lg-9">
			<input type="text" id="sert_full" name="sert_full" value="{$product->sert_full|htmlentitiesUTF8}" />
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-lg-3" for="gtd">
			<span class="label-tooltip" data-toggle="tooltip"
				title="Номер Грузовой таможенной декларации">
				{$bullet_common_field} ГТД
			</span>
		</label>
		<div class="col-lg-3">
			<input type="text" id="gtd" name="gtd" value="{$product->gtd|htmlentitiesUTF8}" />
		</div>
	</div>

	<div class="form-group">
		<label class="control-label col-lg-3" for="sg">
			<span class="label-tooltip" data-toggle="tooltip"
				title="0-Посрочен 4-Бессрочно">
				{$bullet_common_field} Срок годности (осталось лет)
			</span>
		</label>
		<div class="col-lg-3">
			<input type="text" id="sg" name="sg" value="{$product->sg|htmlentitiesUTF8}" />
		</div>
	</div>

	<div class="form-group">
		<label class="control-label col-lg-3" for="sgt">
			<span class="label-tooltip" data-toggle="tooltip"
				title="Срок годности в формате 05-21">
				{$bullet_common_field} Срок годности (до ММ-ГГ)
			</span>
		</label>
		<div class="col-lg-3">
			<input type="text" id="sgt" name="sgt" value="{$product->sgt|htmlentitiesUTF8}" />
		</div>
	</div>
